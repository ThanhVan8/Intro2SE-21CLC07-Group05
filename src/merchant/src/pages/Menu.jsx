  ...
  return (
    <>
      ...
      <div className="w-full min-h-screen mt-28 mb-8 px-10 font-mono text-base">
				<p className="text-center font-serif text-3xl font-semibold pb-5">MENU</p>
        <div className="grid justify-items-end">
          <button
            className="w-fit bg-primary text-white font-medium p-2 rounded-lg capitalize"
        ...
        <div className="flex flex-col items-center mt-5 gap-4">
          {menuData &&
            menuData.FoodList.map((food, index) => {
              return (
                <FoodCard
                  index={index}
                  foodName={food}
